...
// ------------------------------------------------------------------------------------------------------------------------comingsoon
    var muzzles = [
        ...
        { name: 'Choke', image: 'attachments/shotguns/725/comingsoon' },
        { name: 'Lightweight Suppressor', image: 'attachments/shotguns/725/comingsoon' },
    ...
    if (muzzle != false){
     ...
     var barrels = [
        { name: 'Tempus Smooth Bore', image: 'attachments/shotguns/725/comingsoon' }, 
        { name: 'Sawed-off Barrel', image: 'attachments/shotguns/725/comingsoon' },  
        { name: 'Tempus 32 Cometition', image: 'attachments/shotguns/725/comingsoon' },
      ];
...
// -------------------------------------------------------------------------------------------------------------------------------NEED TO DO
    ...
    var underbarrels = [
        ...
        { name: 'Ranger Foregrip', image: 'attachments/shotguns/725/comingsoon' },
...
var reargrips = [
    { name: 'Granulated Grip Tape', image: 'attachments/shotguns/725/comingsoon' },
    { name: 'Rubberized Grip Tape', image: 'attachments/shotguns/725/comingsoon' },
    { name: 'Stippled Grip Tape', image: 'attachments/shotguns/725/comingsoon' },
];
