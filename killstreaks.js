...
// --------- 3
    ...
    //Shield Turret
    var ks3 = [
        { name: 'Personal Radar', image: 'killstreaks/personalradar.png' }, 
        { name: 'Shield Turret', image: 'killstreaks/shieldturret.png' }
      ];
    ...
    // --------- 4
        ...
        //Care Package
    var ks4 = [
        { name: 'Counter UAV', image: 'killstreaks/counteruav.png' }, 
        { name: 'UAV', image: 'killstreaks/uav.png' },
        { name: 'Care Package', image: 'killstreaks/carepackage.png' },
      ];
    // --------- 5
        //Cluster Strike
        //Cruise Missile
        //Precision Airstrike
    var ks5 = [
        { name: 'Cluster Strike', image: 'killstreaks/clusterstrike.png' }, 
        { name: 'Cruise Missile', image: 'killstreaks/cruisemissile.png' },
        { name: 'Precision Airstrike', image: 'killstreaks/precisionairstrike.png' },
      ];
    // --------- 7
        ...
        //Wheelson
    var ks7 = [
        { name: 'Infantry Assault Vehicle', image: 'killstreaks/infantry.png' }, 
        { name: 'Sentry Gun', image: 'killstreaks/sentrygun.png' },
    ...
    // --------- 10
        ...
        //Chopper Gunner
           var ks10 = [
        { name: 'White Phosphorus', image: 'killstreaks/white.png' }, 
        { name: 'Chopper Gunner', image: 'killstreaks/choppergunner.png' }
      ];
    
    // --------- 11
        //Support Helo
           var ks11 = [
        { name: 'Support Helo', image: 'killstreaks/white.png' }
      ];
    ...
    // --------- 12
        ...
        //Advanced UAV
           var ks12 = [
        { name: 'Gunship', image: 'killstreaks/gunship.png' },
        { name: 'Advanced UAV', image: 'killstreaks/advanced.png' }
      ];
    // --------- 15
        //Juggernaut
               var ks15 = [
        { name: 'Juggernaut', image: 'killstreaks/juggernaut.png' }
      ];
