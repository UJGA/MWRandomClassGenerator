function r90(){
    ...
    var muzzles = [
        ...
        { name: 'Choke', image: 'attachments/shotguns/r90shotgun/comingsoon' },
        { name: 'Lightweight Suppressor', image: 'attachments/shotguns/r90shotgun/comingsoon' },
    ...
    if (muzzle != false){
     ...
     var barrels = [
        { name: 'FORGE TAC Sentry', image: 'attachments/shotguns/r90shotgun/comingsoon' }, 
        { name: 'FORGE TAC Gemini', image: 'attachments/shotguns/r90shotgun/comingsoon' },  
      ];
    ...
    var optics = [
        ...
        { name: 'Solozero NVG Enhanced', image: 'attachments/shotguns/optics/' },
    ...
    var pumps = [
        { name: 'FSS R9-0 Bulldog', image: 'attachments/shotguns/r90shotgun/comingsoon' },
        { name: 'FTAC Ultralight Pump', image: 'attachments/shotguns/r90shotgun/comingsoon' },
        { name: 'FTAC Close Quarters Pro', image: 'attachments/shotguns/r90shotgun/comingsoon' },
      ];
    ...
    var underbarrels = [
        ...
        { name: 'Ranger Foregrip', image: 'attachments/shotguns/r90shotgun/comingsoon' },
...
var reargrips = [
    { name: 'Granulated Grip Tape', image: 'attachments/shotguns/r90shotgun/comingsoon' },
    { name: 'Rubberized Grip Tape', image: 'attachments/shotguns/r90shotgun/comingsoon' },
    { name: 'Stippled Grip Tape', image: 'attachments/shotguns/r90shotgun/comingsoon' },
];
