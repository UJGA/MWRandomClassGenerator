function dragunov(){
    ...
    if (muzzle != false){
     ...
     var barrels = [
        { name: '510mm Compact Barrel', image: 'attachments/snipers/510mmcompact.png' }, 
        { name: '660mm Extended Barrel', image: 'attachments/snipers/660mmextended.png' }, 
      ];
    ...
    var stocks = [
        { name: 'FTAC Hunter-Scout', image: 'attachments/snipers/hunter.png' },
        { name: 'Skeleton Stock', image: 'attachments/snipers/skeleton.png' },
        { name: 'VLK Lightweight Stock', image: 'attachments/snipers/lightweight.png' },
        { name: 'FTAC Stalker-Scout', image: 'attachments/snipers/stalker.png' },
    ...
    if (underbarrel != false){
     ...
     var ammunations = [
        { name: '15 Round Mags', image: 'attachments/snipers/15.png' },
        { name: '20 Round Mags', image: 'attachments/snipers/20.png' },
      ];
