function aug(){
    ...
    if (muzzle != false){
     ...
     var barrels = [
        { name: '407mm Extended Barrel', image: 'attachments/smgs/407mmextendedbarrel.png' }, 
        { name: '407mm Lightweight', image: 'attachments/smgs/407mmlightweight.png' }, 
        { name: '622mm Long Barrel', image: 'attachments/smgs/622mmlongbarrel.png' }, 
      ];
    ...
    var optics = [
        ...
        { name: 'Integral 3.0x Optic', image: 'attachments/smgs/integral30x.png' },
    ...
    if (underbarrel != false){
     ...
     var ammunations = [
        { name: '32 Round Mags', image: 'attachments/smgs/32roundmags.png' },
        { name: '5.56 NATO 30-Round Mags', image: 'attachments/smgs/556nato30roundmags.png' },
        { name: '5.56 NATO 60-Round Drums', image: 'attachments/smgs/556nato60rounddrums.png' },
      ];
