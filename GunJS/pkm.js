function pkm(){
    ...
    if (muzzle != false){
     ...
     var barrels = [
        { name: '18.2 Compact Barrel', image: 'attachments/lmgs/barrels/182compact.png' }, 
        { name: '26.9 Extended Barrel', image: 'attachments/lmgs/barrels/269extended.png' }, 
        { name: '25.9 Heavy Barrel', image: 'attachments/lmgs/barrels/259heavy.png' }, 
    ...
    var underbarrels = [
        ...
        { name: 'Snatch Grip', image: 'attachments/lmgs/underbarrels/snach.png' },
    ...
    if (underbarrel != false){
     ...
     var ammunations = [
        { name: '150 Round Belt', image: 'attachments/lmgs/ammunations/150.png' },
        { name: '200 Round Belt', image: 'attachments/lmgs/ammunations/200.png' },
