function hdr(){
    ...
    if (muzzle != false){
     ...
     var barrels = [
        { name: '26.9 HDR Pro', image: 'attachments/snipers/hdrpro.png' }, 
        { name: '26.0 Bull Barrel', image: 'attachments/snipers/260bull.png' }, 
        { name: '17.2 Bull Barrel', image: 'attachments/snipers/172bull.png' },
      ];
    ...
    var stocks = [
        { name: 'FTAC Stalker-Scout', image: 'attachments/snipers/stalkerhdr.png' },
        { name: 'FTAC Hunter-Scout', image: 'attachments/snipers/hunterhdr.png' },
        { name: 'FSS Nomad Stock', image: 'attachments/snipers/nomad.png' },
        { name: 'FTAC Champion', image: 'attachments/snipers/champion.png' },
      ];
