function holger(){
    ...
    if (muzzle != false){
     ...
     var barrels = [
        { name: 'XRX Ultralight', image: 'attachments/lmgs/barrels/ultralight.png' }, 
        { name: 'FTAC 8.98 Spitfire', image: 'attachments/lmgs/barrels/spitfire.png' }, 
    ...
    var optics = [
        ...
        { name: 'FSS Integral Reflex', image: 'attachments/lmgs/optics/integralreflex.png' },
        { name: 'Solozero K498 4.0x Integral', image: 'attachments/lmgs/optics/solozerintegral.png' },
    ...
    var stocks = [
        { name: 'FSS Ranger', image: 'attachments/lmgs/stocks/ranger.png' },
        { name: 'FSS infantry', image: 'attachments/lmgs/stocks/infantry.png' },
        { name: 'No Stock', image: 'attachments/lmgs/stocks/nostock.png' },
        { name: 'XRX Axis', image: 'attachments/lmgs/stocks/axis.png' },
    ...
    if (underbarrel != false){
     ...
     var ammunations = [
        { name: '30 Round Mags', image: 'attachments/lmgs/ammunations/30.png' },
