function ram7(){
    ...
    if (muzzle != false){
     ...
     var barrels = [
        { name: 'FTAC 13.5 Compact', image: 'attachments/barrels/compact.png' }, 
        { name: 'FORGE TAC Eclipse', image: 'attachments/barrels/eclipse.png' }, 
        { name: 'XRX Ranger', image: 'attachments/barrels/ranger.png' },
      ];
    ...
    var stocks = [
        { name: 'FTAC Equilibrium', image: 'attachments/stocks/equilibrium.png' },
        { name: 'XRX Ultralight Hollow', image: 'attachments/stocks/hollow.png' }, 
        { name: 'XRX Close Quarters', image: 'attachments/stocks/quarters.png' },
      ];
    ...
    if (underbarrel != false){
     ...
     var ammunations = [
        { name: '45 Round Mags', image: 'attachments/ammunations/45.png' },
