function sa87(){
    ...
    if (muzzle != false){
     ...
     var barrels = [
        { name: 'SA87 18.2 Factory', image: 'attachments/lmgs/barrels/182factory.png' }, 
        { name: 'SA87 25.4 Factory', image: 'attachments/lmgs/barrels/254factory.png' }, 
        { name: 'SA87 12.4 Factory', image: 'attachments/lmgs/barrels/124factory.png' }, 
    ...
    var stocks = [
        { name: 'FSS SA87 Heavy Stock Pro', image: 'attachments/lmgs/stocks/sa87heavy.png' },
        { name: 'SA87 Ultalight Hollow', image: 'attachments/lmgs/stocks/sa87ultralight.png' },
        { name: 'FORGE TAC CQB Comb', image: 'attachments/lmgs/stocks/comb.png' },
    ...
    var underbarrels = [
        ...
        { name: 'Bipod', image: 'attachments/lmgs/underbarrels/bipodsa87.png' },
    ...
    if (underbarrel != false){
     ...
     var ammunations = [
        { name: '50 Round Mags', image: 'attachments/lmgs/ammunations/50.png' },
        { name: '60 Round Mags', image: 'attachments/lmgs/ammunations/60.png' },
...
var reargrips = [
{ name: 'Granulated Grip Tape', image: 'attachments/lmgs/reargrips/granulated.png' },
{ name: 'Stippled Grip Tape', image: 'attachments/lmgs/reargrips/stippled.png' },
{ name: 'Rubberized Grip Tape', image: 'attachments/lmgs/reargrips/rubberized.png' },
